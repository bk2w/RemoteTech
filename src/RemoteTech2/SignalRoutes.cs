...
//                        else RTLog.Notify("Link has receivers");
        ...
        public override void OnSave(ConfigNode configNode)
        {
            ...
            try 
            {
                foreach (var sat in mSignalRoutes.Keys.Where(a => (a != null) && (mSignalRoutes[a] != null)))
                {
                    try
                    {
                    ...
                    {
                        Debug.LogError("Failed to save route for " + sat.Name);
            ...
            {
                Debug.LogError("Failed to save any routes");
                Debug.LogException(e);
            }
